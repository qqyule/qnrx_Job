...
class Notify_pub extends Wxpay_server_pub 
{
	public function __construct($data) {
		WxPayConf_pub::$appid = C('qscms_weixin_appid');
		WxPayConf_pub::$mchid = $data['partnerid'];
		WxPayConf_pub::$key = $data['ytauthkey'];
		WxPayConf_pub::$appsecret = C('qscms_weixin_appsecret');
	}
}
