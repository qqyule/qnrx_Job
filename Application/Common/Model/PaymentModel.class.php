...
class PaymentModel extends Model{
	protected $_validate = array(
		...
		array('byname,parameter1,parameter2,parameter3','identicalLength_50','',0,'callback'),
    ...
    public function config_cache() {
        $config = array();
        $res = $this->where(array('p_install'=>2))->getField('typename,byname,partnerid,ytauthkey,fee,parameter1,parameter2,parameter3');
