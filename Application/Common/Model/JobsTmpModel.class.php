...
class JobsTmpModel extends Model{
	protected $_validate = array(
		array('uid,jobs_name,companyname,company_id,company_addtime,nature,sex,amount,topclass,category,subclass,trade,scale,district,tag,education,experience,wage,contents,deadline,setmeal_deadline,setmeal_id,key,tpl','identicalNull','',0,'callback'),
		array('uid,company_id,company_addtime,stick,nature,sex,amount,topclass,category,subclass,trade,scale,tag,education,experience,wage,deadline,setmeal_deadline,setmeal_id','identicalEnum','',0,'callback'),
