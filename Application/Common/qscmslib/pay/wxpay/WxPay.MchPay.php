...
class MchPay{
    protected $_payment_url = 'https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers';
    ...
    public function postXmlSSL($parameters){
        $parameters['mch_appid'] = WxPayConfig::$appid;
        $parameters['mchid']     = WxPayConfig::$mchid;
