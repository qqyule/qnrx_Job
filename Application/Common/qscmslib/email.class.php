...
class email
{
    ...
    */
    public function label_replace($templates,$replac)
    {
        ...
        $replac['logo']=C('qscms_logo_home')?attach(C('qscms_logo_home'),'resource'):'/Application/Home/View/'.C('qscms_template_dir').'/public/images/logo_home.png';
        $replac['bootom_tel']=C('qscms_bootom_tel')?C('qscms_bootom_tel'):C('qscms_top_tel');
        $replac['contact_email']=C('qscms_contact_email');
        $replac['qrcode']=attach(C('qscms_weixin_img'),'resource');
