...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'<head><meta charset=utf-8"utf-8" /><title></title>',
		'<style>',
...
/*
* 濡備綍瀹炵幇鐪熸鐨勮嚜鍔ㄩ珮搴︼紵
* 淇敼缂栬緫鍣ㄩ珮搴︿箣鍚庯紝鍐嶆鑾峰彇body鍐呭楂樺害鏃讹紝鏈€灏忓€煎彧浼氭槸褰撳墠iframe鐨勮缃珮搴︼紝杩欐牱灏卞鑷撮珮搴﹀彧澧炰笉鍑忋€?
* 鎵€浠ユ瘡娆¤幏鍙朾ody鍐呭楂樺害涔嬪墠锛屽厛灏唅frame鐨勯珮搴﹂噸缃负鏈€灏忛珮搴︼紝杩欐牱灏辫兘鑾峰彇body鐨勫疄闄呴珮搴︺€?
* 鐢辨灏卞疄鐜颁簡鐪熸鐨勮嚜鍔ㄩ珮搴?
* 娴嬭瘯锛歝hrome銆乫irefox銆両E9銆両E8
* */
/*******************************************************************************
* KindEditor - WYSIWYG HTML Editor for Internet
* Copyright (C) 2006-2011 kindsoft.net
