...
class UploadController extends BackendController{
	...
	public function index(){
		if(IS_POST){
			...
			if(!in_array($dir,array('top_resume_img','top_word_resume','file','flash','image'))) return false;
	...
	public function form_upload(){
		...
		if(!in_array($dir,array('resource','images','top_resume_img','mall','jobfair','jobfair_tpl','link_logo','hrtools','consultant','attach_img','hrtools_img','setmeal_img','storetransfer','house_rent','promotion'))) return false;
		if(IS_POST){		
