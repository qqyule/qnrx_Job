...
<?php echo ($synsitegroup); ?>
	...
	<link href="<?php echo C('TPL_PUBLIC_DIR');?>/css/news.css" rel="stylesheet" type="text/css" />
    ...
    <div class="ot_nav_box">
        ...
        <div class="ot_nav_link <?php if($apply['Subsite'] || $sitegroup): ?>has_sub<?php endif; ?>">
            <ul class="link_gray6 nowrap">
                <?php $tag_nav_class = new \Common\qscmstag\navTag(array('列表名'=>'nav','调用名称'=>'QS_top','显示数目'=>'8','cache'=>'0','type'=>'run',));$nav = $tag_nav_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("pname"=>"","title"=>"新闻资讯","keywords"=>"","description"=>"","header_title"=>""),$nav);?>
  ...
  <div class="r">
	...
	<?php if(is_array($ad['list'])): $i = 0; $__LIST__ = $ad['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad_info): $mod = ($i % 2 );++$i;?><div class="ad313_165">
	    	<a href="<?php echo ($ad_info["href"]); ?>" title="<?php echo ($ad_info["title"]); ?>">
				<img src="<?php echo attach($ad_info['content'],'attach_img');?>" border="0">
			</a>
		</div><?php endforeach; endif; else: echo "" ;endif; ?>
