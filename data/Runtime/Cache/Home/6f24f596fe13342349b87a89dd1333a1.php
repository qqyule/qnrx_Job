...
<?php else: ?>
	...
	<?php else: ?>
		...
		<div class="name com_name">
			<a class="aname" href="<?php echo U('company/index',array('uid'=>$visitor['uid']));?>"><?php echo ($company["companyname"]); ?></a><div class="vertical_line"></div><div class="arrow_icon"></div><div class="arrow_icon_hover"></div>
			<div class="name_list">
