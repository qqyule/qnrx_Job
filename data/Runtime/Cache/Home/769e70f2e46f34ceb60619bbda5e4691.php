        ...
        <div class="star_employer_box" stats="0">
            ...
            <ul id="star_company_logos_ul">
                <?php if(is_array($ad['list'])): $i = 0; $__LIST__ = $ad['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad_info): $mod = ($i % 2 );++$i;?><li>
                        <a target="_blank" href="<?php echo ($ad_info["href"]); ?>" title="<?php echo ($ad_info["title"]); ?>" <?php if(!$ad_info.company): ?>class="no_com"<?php endif; ?>><img src="<?php echo attach($ad_info['content'],'attach_img');?>"><?php if($ad_info.company): ?><span><?php echo ($ad_info["company"]["companyname"]); ?></span><?php endif; ?></a>
