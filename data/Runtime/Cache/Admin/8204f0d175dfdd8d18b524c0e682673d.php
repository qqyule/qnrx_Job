...
<head>
	...
	<script>
		var URL = '/index.php/admin/config',
			SELF = '/index.php?m=admin&amp;c=config&amp;a=agreement',
...
<form action="<?php echo U('text/edit');?>" method="post" name="form1" id="form1">
    <div class="toptit">会员注册协议</div>
    <div class="form_main">
        <div class="fl"></div>
        <div class="fr">
            <textarea name="value" class="input_text_default" style=" width:700px;height:400px; font-size:12px; line-height:180%" id="agreement"><?php echo ($agreement["value"]); ?></textarea>
        </div>
        <div class="fl"></div>
        <div class="fr">
...
<script>
  ...
  KindEditor.ready(function(K) {
    editor = K.create('textarea[name="value"]', {
      uploadJson : "?m=<?php echo C('admin_alias');?>&c=upload&a=index",
