...
<form action="<?php echo U('config/edit');?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
    ...
    <div class="form_main width200">
        ...
        <div class="fl">网站会员中心Logo：</div>
        <div class="fr J-file-input-box">
            <?php if(C('qscms_logo_user')): ?><div class="file-input-src">
                    <div class="img"><img src="<?php echo attach(C('qscms_logo_user'),'resource');?>?_t=<?php echo time();?>" align=absmiddle></div>
                    <div class="del file-input-del" id="J_upload_logo_user_btn" name="logo_user">点击更换</div>
                    <div class="r-note">(建议尺寸210*55)</div>
                </div>
            <?php else: ?>
                <div class="file-input-src hid">
                    <div class="img"></div>
                    <div class="del file-input-del" id="" name="logo_user">点击更换</div>
                    <div class="r-note">(建议尺寸210*55)</div>
                </div>
                <div class="file-input-block" id="J_upload_logo_user_btn" name="logo_user" ><span class="o-txt">上传</span>网站会员中心Logo<span class="re-txt">(建议尺寸210*55)</span></div><?php endif; ?>
            <input type="hidden" class="file-input-save-name" name="logo_user" value="<?php echo C('qscms_logo_user');?>">
        </div>
